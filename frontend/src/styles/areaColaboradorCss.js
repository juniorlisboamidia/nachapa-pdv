...
.be-root{--bg:#F4F1EA;--surface:#FFFFFF;--surface-2:#EFEADF;--ink:#0E1319;--ink-soft:#474D55;--muted:#8A8E94;--line:#E5DFD2;--brand:#f97316;--brand-deep:#9a3412;--brand-tint:#fff7ed;--money:#0F8A54;--gold:#f97316;--gold-text:#9a3412;--silver:#94A0AC;--bronze:#BE7043;--dark:#0E1319;--sh-sm:0 1px 2px rgba(14,19,25,.06);--sh-md:0 3px 8px rgba(14,19,25,.07),0 16px 34px rgba(14,19,25,.08);--rd:18px;
...
@media (prefers-color-scheme:dark){.be-root{--bg:#0E1319;--surface:#171E27;--surface-2:#121821;--ink:#F3EEE3;--ink-soft:#CFC9BD;--muted:#8F97A1;--line:#28313C;--brand:#f97316;--brand-deep:#9a3412;--brand-tint:#2C2A14;--money:#3FBE82;--gold:#fb923c;--gold-text:#fb923c;--sh-sm:0 1px 2px rgba(0,0,0,.4);--sh-md:0 3px 8px rgba(0,0,0,.4),0 18px 36px rgba(0,0,0,.5)}}
...
/* Hero */
.be-hero{position:sticky;top:0;z-index:20;color:#fff;padding:14px 18px;border-radius:0 0 22px 22px;background:radial-gradient(120% 90% at 86% -20%,rgba(249,115,22,.20),transparent 58%),linear-gradient(165deg,#1B2532 0%,#0E1319 62%);box-shadow:0 10px 26px rgba(14,19,25,.30)}
...
.be-avatar{width:54px;height:54px;border-radius:16px;flex-shrink:0;background:linear-gradient(145deg,#fb923c,#ea580c);display:grid;place-items:center;font-size:23px;font-weight:850;color:#fff;box-shadow:0 6px 16px rgba(249,115,22,.28)}
...
.be-rank-pill.g1 .m{background:linear-gradient(150deg,#fb923c,var(--gold))}
...
.be-idx{margin-top:14px;padding:13px;border-radius:14px;background:var(--brand-tint);border:1px solid rgba(249,115,22,.32)}
...
.be-idx-bar{height:9px;border-radius:999px;background:rgba(249,115,22,.2);overflow:hidden;margin-top:8px}
.be-idx-bar i{display:block;height:100%;border-radius:999px;background:linear-gradient(90deg,#fb923c,var(--brand))}
...
/* Carteira / Mercado */
.be-wallet{background:radial-gradient(120% 120% at 85% -10%,rgba(249,115,22,.28),transparent 55%),linear-gradient(180deg,var(--surface),var(--surface-2));border:1px solid var(--line);border-radius:20px;padding:20px;box-shadow:var(--sh-md);text-align:center}
...
.be-coins{display:inline-flex;align-items:center;gap:6px;background:linear-gradient(135deg,#fb923c,#f97316);color:#fff;font-weight:850;border-radius:999px;padding:6px 13px;font-size:14px;box-shadow:var(--sh-sm)}
...
.be-shop-btn{margin-top:5px;border:none;border-radius:10px;padding:8px;font-size:12.5px;font-weight:850;cursor:pointer;background:linear-gradient(135deg,#fb923c,var(--brand));color:#fff}
...
.be-btn{width:100%;font-family:inherit;font-size:14.5px;font-weight:850;color:#fff;background:linear-gradient(135deg,#fb923c,var(--brand));border:none;border-radius:12px;padding:12px 18px;cursor:pointer;box-shadow:var(--sh-sm)}
...
.be-dlg-row .ok{border:none;background:linear-gradient(135deg,#fb923c,var(--brand));color:#fff}
...
/* Login */
.be-login{min-height:100dvh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:28px 18px;background:radial-gradient(120% 50% at 50% -8%,rgba(249,115,22,.16),transparent 62%),radial-gradient(90% 42% at 50% 112%,rgba(249,115,22,.08),transparent 60%),#13172b}
...
.be-login .be-input:focus{border-color:var(--brand);box-shadow:0 0 0 3px rgba(249,115,22,.18)}
.be-login .be-cod{letter-spacing:.35em;font-size:26px;padding-left:.35em;font-variant-numeric:tabular-nums}
.be-login .be-btn{padding:14px 18px;font-size:15px;box-shadow:0 4px 14px rgba(249,115,22,.4);transition:transform .12s,box-shadow .18s,opacity .18s}
